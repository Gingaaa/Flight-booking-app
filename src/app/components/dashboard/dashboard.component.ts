...
export class DashboardComponent implements OnInit {
  ...
  slide5: string = 'assets/images/slide-5.jpg';
  ...
  toEmail: string = 'mmohan8851@gmail.com';
  onSubmit() {
    localStorage.setItem('formData', JSON.stringify(this.myForm.value));
    // console.log(this.myForm.value);
    this.router.navigateByUrl('/list');
    
    // const fromEmail = 'trashid8882@gmail.com';
    // const emailContent = '<h1>Hello</h1><p>This is an example email</p>';
    // const postData = {
    //   fromEmail,
    ...
    // };
    // this.http.post('/send-email', postData).subscribe((response) => {
    ...
    // this.router.navigateByUrl('/list?orderby=price&category=fiction&date=4/12/2023');
  }

  getUrl(){
    // this.router.navigateByUrl('/flights-to-miami?image=1');
    this.router.navigateByUrl('/flights-to-miami?image=2');
...
// updateValue(){
//   this.setInovice.itemTotal=0;
//   for (var i = 0; i <= this.invoiceForm.value.address.length; i++) {
//     this.setInovice.itemTotal= this.setInovice.itemTotal + (this.isNumber(this.invoiceForm.value.address[i].street));
//     console.log(this.setInovice.itemTotal);
